...
export const STACKS: StackDef[] = [
  ...
  },
  {
    code: "react-router",
    label: "REACT ROUTER",
    iconPath: icon("react-router.svg"),
    priority: 38,
    category: "frontend",
  },
  {
    ...
    iconPath: icon("create-react-app.svg"),
    priority: 20,
    category: "frontend",
  },
  ...
  },
  {
    ...
    iconPath: icon("github-copilot.svg"),
    priority: 55,
    category: "tooling",
  },
